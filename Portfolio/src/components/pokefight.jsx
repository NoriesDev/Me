...
const Pokefight = () => {
    ...
    return (
        <>
            ...
            <p className="text-white font-bold text-xl font-four">A Pokemon card game</p>
            ...
            <Image src='https://repository-images.githubusercontent.com/712002277/a0e7c701-3489-47ed-94c8-a9720adf7101' className=" z-[1] relative rounded  h-[225px] w-[500px] object-cover my-2" />
